...
class GymEnv(CameraEnv):
    ...
    def _init_task_and_reward(self):
        ...
        reward_classes = {
            ...
            "4-network": {"pnp": FourStagePnP,"pnpnStay": FourStagePnPnStay,"pnpMass": FourStagePnPmassDistr, "pnprot": FourStagePnPRot, "FMLFR": FaMaLaFaR}}
        ...
        if not "init" in object_dict.keys():  # solves used_objects
            ...
            for o in ['init', 'goal']:
                ...
                if d["obj_name"] != "null":
                    ...
                    # this highlights the init and goal object
